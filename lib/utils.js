...
exports.sendEmail = function(emailAddress, filePath){
  var email = {
    from        : { address : 'Pete Za <postmaster@' + config.MAILGUN_DOMAIN + '>' },
    to          : emailAddress,
    subject     : 'REMIX BOOTH',
    text        : 'Thanks for stepping inside the REMIX BOOTH. Here\'s that copy of your video you requested. #RespectTheREMIX',
    attachment  : filePath
  };
